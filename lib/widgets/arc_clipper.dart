...
class Arc extends StatelessWidget {
  const Arc(
      {Key? key, required this.height, required this.child, this.edge = Edge.BOTTOM, this.arcType = ArcType.CONVEX})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return CustomPaint(child: ClipPath(clipper: clipper, child: child));
  }
}
